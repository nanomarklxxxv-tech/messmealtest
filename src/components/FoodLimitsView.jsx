        ...
        <div className="space-y-6 animate-fade-in pb-24">
            ...
            <div className="bg-white dark:bg-[#1A1A1A] rounded-[2.5rem] border-[4px] border-primary overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.45)] transition-all duration-300 hover:shadow-2xl">
                ...
                <div className="p-8 md:p-12">
                    <div className="flex items-start gap-6 p-6 md:p-10 rounded-[2rem] bg-amber-500/5 border-2 border-amber-500/10 dark:bg-amber-500/10 dark:border-amber-500/20">
                        <div className="bg-amber-500/20 p-3 rounded-2xl mt-1 flex-shrink-0">
                            <AlertTriangle size={24} className="text-amber-600 dark:text-amber-400" />
                        </div>
                        <div className="space-y-6">
                            <p className="text-[#0D0D0D] dark:text-[#F0F0F0] text-lg md:text-xl font-bold leading-[1.8] whitespace-pre-wrap tracking-tight">
                                {foodLimits}
                            </p>
                            <div className="pt-6 border-t border-amber-500/10 dark:border-amber-500/20">
